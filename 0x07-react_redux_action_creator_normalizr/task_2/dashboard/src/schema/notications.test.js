...
describe("tests that the following data is returned", () => {
  ...
  it("to verrify that your normalizd data has a correct result array", () => {
    const data = [
  ...
  it("test to verify that your normalized data has a correct users entity", () => {
    const data = {
      age: 25,
  ...
  it("to test that your normalized data has a correct notifications entity", () => {
    const data = {
